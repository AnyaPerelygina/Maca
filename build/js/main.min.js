...
var _toggle = require("./modules/header/toggle");
var _initAccordion = require("./vendor/accordion/init-accordion");
var _heroSlider = require("./modules/hero/hero-slider");
var _programs = require("./modules/programs/programs");
var _newsTab = require("./modules/news/news-tab");
var _newsSlider = require("./modules/news/news-slider");
var _reviews = require("./modules/reviews/reviews");
var _leaflet = require("./modules/leaflet/leaflet");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _newsSlider.createNewsSlider)();
  (0, _toggle.addToggleMenu)();
  (0, _initAccordion.initAccordions)();
  (0, _heroSlider.createHeroSlider)();
  (0, _programs.createProgramsSlider)();
  (0, _newsTab.addTabHandler)();
  (0, _reviews.createReviewsSlider)();
  (0, _leaflet.initLeaflet)();
...
},{"./modules/form-validate/form":3,"./modules/header/toggle":9,"./modules/hero/hero-slider":10,"./modules/leaflet/leaflet":11,"./modules/modals/init-modals":12,"./modules/news/news-slider":14,"./modules/news/news-tab":15,"./modules/programs/programs":16,"./modules/reviews/reviews":17,"./utils/ios-vh-fix":20,"./vendor/accordion/init-accordion":23,"./vendor/select/custom-select":26}],2:[function(require,module,exports){
"use strict";
...
var addToggleMenu = function addToggleMenu() {
  ...
  var LINK_CLASS = '.nav__link';
  var root = document.querySelector('.header');
  var container = root.querySelector('.header__container');
  ...
  var openMenu = function openMenu() {
    ...
    _scrollLock.ScrollLock.disableScrolling();
  ...
  var closeMenu = function closeMenu() {
    ...
    _scrollLock.ScrollLock.enableScrolling();
    document.removeEventListener('click', onDocumentOutside);
  };
  var onDocumentOutside = function onDocumentOutside(evt) {
...
exports.createHeroSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var elementHero = document.querySelector('.hero__swiper');
var createHeroSlider = function createHeroSlider() {
  if (elementHero) {
    /* eslint-disable */
    new _swiper.default('.hero__swiper', {
      /* eslint-enable */
      speed: 1500,
      loop: true,
      effect: 'fade',
...
},{"../../vendor/swiper":28}],11:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initLeaflet = void 0;
var _leaflet = _interopRequireDefault(require("../../vendor/leaflet"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initLeaflet = function initLeaflet() {
  var map = _leaflet.default.map('map', {
    scrollWheelZoom: false,
    dragging: false
  }).setView([55.0286301613192, 82.9282483391627], 14);
  ...
  _leaflet.default.marker([55.0286301613192, 82.9282483391627], {
    icon: myIcon
  }).addTo(map);
};
exports.initLeaflet = initLeaflet;
...
exports.createNewsSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var elementNews = document.querySelector('.news__swiper');
var createNewsSlider = function createNewsSlider() {
  if (elementNews) {
    /* eslint-disable */
    new _swiper.default('.news__swiper', {
      /* eslint-enable */
      speed: 1500,
      loop: false,
...
exports.createNewsSlider = createNewsSlider;

},{"../../vendor/swiper":28}],15:[function(require,module,exports){
"use strict";
...
var addTabHandler = function addTabHandler() {
  if (document.querySelector('.news__tabs')) {
    ...
    var tabs = root.querySelectorAll('.news__tab');
...
exports.createProgramsSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var elementPrograms = document.querySelector('.programs__slider');
var createProgramsSlider = function createProgramsSlider() {
  if (elementPrograms) {
    /* eslint-disable */
    new _swiper.default('.programs__slider', {
      /* eslint-enable */
      speed: 1500,
      loop: false,
      breakpoints: {
...
exports.createProgramsSlider = createProgramsSlider;

},{"../../vendor/swiper":28}],17:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createReviewsSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var elementReviews = document.querySelector('.reviews__swiper');
var createReviewsSlider = function createReviewsSlider() {
  if (elementReviews) {
    /* eslint-disable */
    new _swiper.default('.reviews__swiper', {
      /* eslint-enable */
      speed: 1500,
      loop: false,
      breakpoints: {
...
exports.createReviewsSlider = createReviewsSlider;

},{"../../vendor/swiper":28}],18:[function(require,module,exports){
"use strict";
...
exports.createNativeSelect = void 0;
var createNativeOptions = function createNativeOptions(items, activeIndex) {
...
var createNativeSelect = function createNativeSelect(_ref) {
  var id = _ref.id,
    items = _ref.items,
...
var _createSelect = require("./create-select");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var CustomSelect = /*#__PURE__*/function () {
  ...
  _createClass(CustomSelect, [{
    ...
    value: function _createSelectStructure(item) {
      ...
      (0, _utils.renderElement)(item, (0, _utils.createElement)((0, _createSelect.createNativeSelect)(options)));
...
},{"./create-select":25,"./utils":27}],27:[function(require,module,exports){
"use strict";
